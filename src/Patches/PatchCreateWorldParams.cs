...
namespace PrepareLanding.Patches
{
    class PatchCreateWorldParams
    {
        ...
        static bool Page_CreateWorldParams_CanDoNext(ref Page_CreateWorldParams __instance, ref bool __result)
        {
            ...
            var landmarkDensity = Traverse.Create(__instance).Field("landmarkDensity").GetValue<LandmarkDensity>();
            ...
            // new page
            var p = new PagePreciseWorldGeneration(planetCoverage, seedString, rainfall, temperature, population, landmarkDensity, factions, pollution);
